        ...
        <div className="w-[80%] md:w-[40%] lg:w-[30%] bg-white shadow-md p-7 rounded-md">
          ...
          <form onSubmit={handleSubmit(handleSignUp)}>
            <div className="my-4">
              ...
              <select
                {...register("role")}
                className="select select-sm  rounded-md border-gray-400 w-full focus:outline-none"
              >
                <option>Buyer</option>
            ...
            <button
              className={
                signInLoading
                  ? " bg-blue-600 cursor-not-allowed text-white duration-300 w-full h-10 rounded-md"
                  : "bg-blue-700 hover:bg-blue-800 text-white duration-300 w-full h-10 rounded-md"
              }
            >
              {signInLoading ? "Sign Up..." : "Sign Up"}
            </button>
            <p className="mt-2">
              Already have an Account?{" "}
              <Link to="/login" className="underline text-[#1E40AF]">
                Login
              </Link>
            </p>
          </form>
          ...
          <button
            ...
            className="bg-slate-700 hover:bg-slate-800 duration-300 w-full h-10 rounded-md"
          >
