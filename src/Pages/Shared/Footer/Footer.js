...
const Footer = () => {
  return (
    <footer className=" bg-accent footer footer-center p-10 text-primary-content">
      <div>
        <Link to='/'><img src={footerLogo} alt="" /></Link>
        <div>
          <NavLink to='/' className='text-lg mx-2'>Home</NavLink>
          <NavLink to='/blog' className='text-lg mx-2'>Blog</NavLink>
          <NavLink to='/login' className='text-lg mx-2'>Login</NavLink>
          <NavLink to='/signup' className='text-lg mx-2'>SignUp</NavLink>
        </div>
