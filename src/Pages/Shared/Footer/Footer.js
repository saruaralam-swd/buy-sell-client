  ...
  return (
    <div className="bg-gray-900 pt-4 border-t border-gray-200 dark:border-gray-800">
      <footer className="p-4 sm:p-6 max-w-7xl mx-auto">
          ...
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center">
              <img
                ...
                alt="PhoneSwap Logo"
              />
              <div className="text-xl my-0 py-0 flex justify-center items-center font-semibold text-white">
        ...
        <div className="flex items-center sm:flex-row flex-col justify-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a
              href="https://twitter.com/saruaralam2001"
              target="_blank"
              rel="noreferrer"
              className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
            >
