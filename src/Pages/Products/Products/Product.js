      ...
      <div className="border border-[#abb6c0] rounded-lg grid md:grid-cols-4 gap-5">
        ...
        <div className=" col-span-4 md:col-span-2 lg:col-span-3 grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="space-y-1">
            ...
            <p>
              {" "}
              <UserCircleIcon className="h-4 w-4 inline-block" /> {sellerName}
            </p>
            <p>
              {" "}
              <PhoneIcon className="h-4 w-4 inline-block" /> {phoneNumber}
            </p>
            <p>
              {" "}
              <MapPinIcon className="h-4 w-4 inline-block" /> {location}
            </p>
            <p>
              Quality: <span className="uppercase">{quality}</span>
            </p>
