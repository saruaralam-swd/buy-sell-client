...
const Blog = () => {
  ...
  return (
    // <div className='px-10'>
    //   <h2 className='font-semibold text-3xl my-5'>Better Programming</h2>
    ...
    //     <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
    //       <div className="collapse-title text-xl font-medium">
    //         <h2 className='text-2xl font-semibold'>What is a unit test? Why should we write unit tests?</h2>
    //       </div>
    //       <div className="collapse-content space-y-2">
    ...
    //     <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
    //       <div className="collapse-title text-xl font-medium">
    //         <h2 className='text-2xl font-semibold' > React vs. Angular vs. Vue?</h2>
    //       </div>
    ...
    // </div>
    <div>
      <h2 className="text-center h-[600px] flex items-center justify-center text-5xl">Coming soon...</h2>
    </div>
  );
};
